...
const HelpCenter = () => {
  return (
    <div className='w-full h-screen flex items-center justify-center'>
      <div className='w-full lg:w-[625px] lg:h-[300px] mx-auto flex flex-col gap-[64px]'>
        <p className='text-[#FFFFFF] text-[32px] font-bold text-center'>Link To Telegram</p>
        <div className='flex items-center justify-between border btnRounded p-4'>
          <div className='flex items-center gap-8'>
            <Image src={ic_helpcenter} alt='icon' />
            <p className='text-[#FDFDFD] text-xl font-normal'>https://t.me/abc</p>
          </div>
          <button className='bg-[#FDFDFD] px-4 py-3 rounded-lg btn'>
